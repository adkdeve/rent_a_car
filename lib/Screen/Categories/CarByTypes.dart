...
class CarByTypes extends StatefulWidget {
  ...
  @override
  _CarByTypesState createState() => _CarByTypesState();
}

class _CarByTypesState extends State<CarByTypes> {
  ...
  void initState() {
    super.initState();
    filteredCars = repository.getCarByType(widget.carType); // Initialize filteredCars with all cars
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Cars by Type', style: TextStyle(color: Colors.white)),
      ),
      body: Column(
        children: [
          // Filter Bar
